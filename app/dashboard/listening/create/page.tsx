...
import { ArrowLeft, Save, Loader2, Music, Upload, Search, Check, X, Library } from 'lucide-react';
...
export default function CreateListeningPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/listening`, data, {
        headers: {
      ...
      if (response.data.success) {
        ...
        throw new Error(response.data.message || 'Failed to create listening material.');
      }
    } catch (err: any) {
  ...
  return (
    <div className="max-w-6xl mx-auto py-6 px-4">
      ...
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900">Create Listening</h1>
          <p className="text-sm text-gray-500 mt-1">Add a new audio passage and description.</p>
        </div>
      </div>
