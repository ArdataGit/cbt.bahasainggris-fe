...
export default function CreateQuestionPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await axios.post(`${process.env.NEXT_PUBLIC_API_URL}/soal-readings`, formData);
